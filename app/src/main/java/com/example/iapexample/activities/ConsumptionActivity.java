...
import com.example.iapexample.adapter.ProductListAdapter;
import com.example.iapexample.utilities.Constants;
import com.example.iapexample.utilities.DeliveryUtils;
import com.example.iapexample.utilities.ExceptionHandle;
...
public class ConsumptionActivity extends AppCompatActivity {
    private String TAG = "ADX2099ConsumptionActivity";
    ...
    private void queryProducts() {
        ...
        productIds.add("gem_001");
        productIds.add("gem_002");
        productIds.add("gem_003");
        productIds.add("gem_004");
        productIds.add("gem_005");
